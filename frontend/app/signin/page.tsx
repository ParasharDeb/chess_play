...
/* ── reuse the same stylesheet (copy-paste or import from a shared file) ── */
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-headline em { font-style: italic; color: var(--muted2); }

  .auth-sub { font-size: 13px; color: var(--muted); font-weight: 300; line-height: 1.5; }
  ...
  .auth-google:hover { background: rgba(255,255,255,0.06); border-color: var(--border-h); }
  ...
  .auth-input:focus { border-color: var(--border-h); background: rgba(255,255,255,0.04); }
  ...
  .auth-footer a { color: var(--accent); text-decoration: none; font-weight: 500; transition: opacity 0.15s; }
  ...
  .auth-strip-piece { font-size: 18px; opacity: 0.15; user-select: none; }
  .auth-strip-text {
    font-family: 'DM Mono', monospace;
    font-size: 10px;
    letter-spacing: 0.1em;
          ...
          <div className="auth-card">
            <div className="auth-body">
              ...
              <motion.div variants={itemVariants} className="auth-header">
                ...
                <h1 className="auth-headline">Your move<br /><em>awaits.</em></h1>
                <p className="auth-sub">Sign in to continue your journey on the board.</p>
              </motion.div>
              ...
              <form className="auth-form" onSubmit={handleSignin}>
                ...
                <motion.div variants={itemVariants} className="auth-field">
                  <div className="auth-label-row">
                    ...
                    <a href="/forgot-password" className="auth-forgot">Forgot?</a>
                  </div>
                  <input
                ...
                <motion.div variants={itemVariants}>
                  <button type="submit" className="auth-submit" disabled={loading} onClick={handleSignin}>
